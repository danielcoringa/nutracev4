...
//Navegação de Cabeçalho
    "txt_controle_usuarios" => "Controle de Usuários",
    "txt_configuracao" => "Configurações",
    "txt_notificacao" => "Notificações",
    "txt_ver_todos" => "Exibir todas",
    "txt_usuarios_online" => "Usuários On-line",
    "txt_agora" => "Agora",
// BreadCrumb e Links
    "txt_bc_usuarios" => "Usuários",
    "txt_bc_index" => "Painel de Controle",
    "txt_bc_principal" => "Principal",
    "txt_bc_perfil" => "Perfil de Usuário",
// Titulos e Descricoes
    "txt_index" => "Painel de Controle",
    "txt_description_index" => "Estatísticas, Relatórios, Previsões e etc.",
    "txt_grid_listagem" => "Listagem de Grids",
    "txt_usuarios" => "Controle de Usuários",
    "txt_description_usuarios" => "Cadastro e Controle de Usuários do Sistema",
//  Grids
    "txt_listagem_de" => "Lista de ",
// Cabeçalho Grid Usuarios
    "txt_cod_usuario" => "Id",
    "txt_nom_nome" => "Nome",
    "txt_nom_usuario" => "Usuário",
    "txt_usuarios" => "Usuários",
    "txt_nom_senha" => "Senha",
    "txt_dat_cadastro" => "Data de Cadastro",
    "txt_ind_ativo" => "Ativo",
    "txt_controles" => "Controles"
);



/**
 * PT_BR-Revision: 22075
 */
$zendReturn = array(
    // Zend_Validate_Alnum
...
$arrRetorno = array_merge($arrRetorno, $zendReturn);
return $arrRetorno;
