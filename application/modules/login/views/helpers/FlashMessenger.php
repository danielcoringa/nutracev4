...
*/
class Login_View_Helper_FlashMessenger extends Zend_View_Helper_Abstract
{
    /**
...
*/
    public function flashMessenger($key = 'warning',
                                   $template='<div class="%s"><strong>%s</strong><a class="close" data-dismiss="alert">&times;</a></div>')
    {
