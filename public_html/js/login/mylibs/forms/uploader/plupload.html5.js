(function(h, k, j, e) {
    ...
    j.runtimes.Html5 = j.addRuntime("html5", {getFeatures: function() {
            ...
            p.bind("Init", function(w) {
                ...
                j.extend(G.style, {position: "relative", background: p.settings.shim_bgcolor || "transparent", width: "100px", height: "100px", overflow: "hidden", zIndex: 99999, opacity: p.settings.shim_bgcolor ? "" : 0});
                ...
                if (w.features.triggerDialog) {
                    j.extend(E.style, {position: "relative", width: "100%", height: "100%"})
                } else {
                ...
                if (s) {
                    if (g) {
                        j.addEvent(s, "dragenter", function(w) {
                            ...
                            j.extend(v.style, {position: "relative", display: "block", top: 0, left: 0, width: u.w + "px", height: u.h + "px", opacity: 0})
                        }, p.id);
                        return
                    }
