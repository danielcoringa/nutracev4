...
(function() {
            ...
            once: function() {
                ...
                return function(j, i, k) {
                    ...
                    if (m) {
                        var r = m.listeners;
                        if (r.length)
                            for (var r = r.slice(0), l, g = 0; g < r.length; g++) {
                                if (m.errorProof)
                                    try {
                                        l = r[g].call(this,
                                                k, i, b, h)
    ...
    CKEDITOR.env || (CKEDITOR.env = function() {
        ...
        if (a.hidpi)
            a.cssClass = a.cssClass + " cke_hidpi";
        return a
    }());
    ...
    (function() {
        ...
        CKEDITOR.tools = {arrayCompare: function(a, f) {
                ...
                if (typeof (b = arguments[f - 1]) == "boolean")
                    f--;
                ...
                for (var a = [].concat(a), b, d = [], c = 0; c < a.length; c++)
                    if (b = a[c])
                        / @import | [{}] / .test(b) ? d.push("<style>" + b + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + b + '">');
                return d.join("")
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function(b, c) {
            ...
            var a = this.$.cloneNode(b), f = function(a) {
                ...
                if (a.nodeType == CKEDITOR.NODE_ELEMENT) {
                    ...
                    if (b)
                        for (var a = a.childNodes, e = 0; e < a.length; e++)
                            f(a[e])
                }
            };
            f(a);
            ...
            for (var c = this.getAddress(), b = b.getAddress(), a = Math.min(c.length, b.length), f = 0; f <= a - 1; f++)
                if (c[f] != b[f]) {
                    if (f < a)
                        return c[f] < b[f] ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING;
                    break
                }
            ...
            if (!c)
                a = a.parentNode;
            for (; a; ) {
                if (a.nodeName && (f = a.nodeName.toLowerCase(), typeof b == "string" ? f == b : f in b))
                    return new CKEDITOR.dom.node(a);
                try {
                    a = a.parentNode
                } catch (d) {
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {type: CKEDITOR.NODE_DOCUMENT, appendStyleSheet: function(b) {
            ...
            for (var a = this.$.documentElement, f =
                ...
                var d = b[f];
                if (c)
                    for (var e = -1, h = 0; h < a.childNodes.length; h++) {
    ...
    (function() {
        function b(a) {
            for (var b = 0, d = 0, e = c[a].length; d < e; d++)
                b = b + (parseInt(this.getComputedStyle(c[a][d]) || 0, 10) || 0);
            return b
        }
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function(a) {
            ...
            getTabIndex: CKEDITOR.env.ie ? function() {
                ...
                if (a && (CKEDITOR.env.webkit || CKEDITOR.env.opera)) {
                    b =
                            this.getWindow();
                    if (!b.equals(CKEDITOR.document.getWindow()) && (d = b.$.frameElement))
                        a = (new CKEDITOR.dom.element(d)).isVisible()
                }
                return!!a
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function() {
                ...
                if (d != a) {
                    ...
                    if (b)
                        for (; c = d.lastChild; )
                            a.insertBefore(d.removeChild(c), a.firstChild);
                    else
                        for (; c = d.firstChild; )
                            a.appendChild(d.removeChild(c))
                }
                ...
                function a(a, b, c) {
                    if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (a.isIdentical(b)) {
                            for (var j = c ? a.getLast() : a.getFirst(); h.length; )
                                h.shift().move(a, !c);
                            b.moveChildren(a, !c);
                            b.remove();
                ...
                if (i < 0 || h > 0)
                    k(0, b === true ? i : b === false ? h : i < 0 ? i : h);
                if (c && (j < 0 || e > 0))
                    k(j < 0 ? j : e, 0)
            ...
            copyAttributes: function(a, b) {
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    ...
                    if (!(j in b))
                        if (j == "checked" && (i = this.getAttribute(j)))
                            a.setAttribute(j, i);
    ...
    (function() {
        function b(a, b) {
            ...
            if (this.current)
                d = this.current[e](false, p, l);
            else {
                if (a)
                    d.type ==
                            CKEDITOR.NODE_ELEMENT && (d = f > 0 ? d.getChild(f - 1) : l(d, true) === false ? null : d.getPreviousSourceNode(true, p, l));
                else {
                    d = m;
                    if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(q)))
                        d = l(m, true) === false ? null : m.getNextSourceNode(true, p, l)
                }
                d && l(d) === false && (d = null)
            }
            for (; d && !this._.end; ) {
    ...
    (function() {
        ...
        var f = function(a) {
            ...
            for (var k = c, t, C, y, n = j; n < f.length; n++) {
                ...
                for (t = t.getNext(); t; ) {
                    if (t.equals(e[n]) || t.equals(d))
                        break;
                    y = t.getNext();
                    if (b == 2)
                        k.append(t.clone(true));
                    else {
                        t.remove();
                        b == 1 && k.append(t)
                    }
            ...
            for (c = j; c < e.length; c++) {
                ...
                if (!f[c] || t.$.parentNode != f[c].$.parentNode)
                    for (t = t.getPrevious(); t; ) {
                        if (t.equals(f[c]) || t.equals(g))
                            break;
                        y = t.getPrevious();
                        if (b == 2)
                            k.$.insertBefore(t.$.cloneNode(true), k.$.firstChild);
                        else {
                            t.remove();
            ...
            getBoundaryNodes: function() {
                    ...
                    if (d)
                        if (d >= c.getLength()) {
                            ...
                            if (this.startContainer.equals(this.endContainer))
                                this.setEnd(p, this.endOffset - this.startOffset);
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        for (; e ||
                            ...
                            if (e && !h) {
                                !i && e.equals(d) && (i = true);
                                if (c ? e.isBlockBoundary() : !g.contains(e))
                                    break;
                            ...
                            for (; h; ) {
                                s = false;
                                if (h.type == CKEDITOR.NODE_COMMENT)
                                    h = h.getPrevious();
                                else {
                                    if (h.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        if (j && CKEDITOR.dtd.$removeEmpty[h.getName()]) {
                                            x = h.getText();
                                            if (/[^\s\ufeff]/.test(x))
                                                h =
                                                        null;
                                            else
                                                for (var k = h.$.getElementsByTagName("*"), t = 0, C; C = k[t++]; )
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            ...
                            if ((e = e.previous()) && e.type == CKEDITOR.NODE_ELEMENT && e.is("br"))
                                break
                        }
                        e = this.clone();
                        e.collapse();
                ...
                if (!this.collapsed) {
                    ...
                    d.guard = function(b, g) {
                        if (k(b))
                            return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || g && b.equals(s) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary())
                            return false;
                        !g && b.type == CKEDITOR.NODE_ELEMENT && (s = b);
                        return true
                    };
                    if (i)
                        (g = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(g, b ? CKEDITOR.POSITION_AFTER_START :
                                CKEDITOR.POSITION_BEFORE_START);
                    if (j) {
                        d.reset();
    ...
    (function() {
        ...
        b.prototype = {getNextParagraph: function(b) {
                ...
                for (this._.nextNode = null; l; ) {
                    ...
                    if (v)
                        l.type == CKEDITOR.NODE_TEXT && a.test(l.getText()) && (v = 0);
                    else {
                        var o = l.getName();
                ...
                if (!d) {
                    ...
                    g = {div: 1, th: 1, td: 1};
                    d = d.block;
                    if (!d && l && !this.enforceRealBlocks && g[l.getName()] && i.checkStartOfBlock() && i.checkEndOfBlock() && !l.equals(i.root))
                        d = l;
                        ...
                        this._.nextNode = d.equals(m) ? null : c(i.getBoundaryNodes().endNode, 1, m)
                }
                if (q)
                    (i = d.getPrevious()) && i.type == CKEDITOR.NODE_ELEMENT && (i.getName() == "br" ? i.remove() : i.getLast() && i.getLast().$.nodeName.toLowerCase() == "br" && i.getLast().remove());
                if (r)
                    (i = d.getLast()) && i.type == CKEDITOR.NODE_ELEMENT && i.getName() == "br" && (CKEDITOR.env.ie || i.getPrevious(f) || i.getNext(f)) && i.remove();
                if (!this._.nextNode)
                    this._.nextNode = k ||
    ...
    (function() {
            ...
            if ((e || typeof a.elements != "function" || a.elements(p)) && (!a.match || a.match(b))) {
                    ...
                    a:if (a.nothingRequired)
                        ...
                        if (f = a.requiredClasses) {
                            ...
                            for (e = 0; e < f.length; ++e)
                                if (CKEDITOR.tools.indexOf(p, f[e]) == -1) {
                                    e = false;
                                    break a
                                }
                        }
                ...
                if (!e) {
                    if (!a.propertiesOnly)
                        g.valid = true;
                    if (!g.allAttributes)
                        g.allAttributes = c(a.attributes, b.attributes, g.validAttributes);
                    if (!g.allStyles)
                        g.allStyles =
                ...
                if (e) {
                    ...
                    if (!e.allAttributes)
                        for (r in v)
                            if (!q[r])
                                if (F.test(r)) {
                                    if (r != (x = r.replace(/^data-cke-saved-/, "")) &&
                                            !q[x]) {
                                        delete v[r];
                                        z = true
                                    }
        ...
        function g(a, b, c) {
            var g = a.name;
            if (A.$empty[g] || !a.children.length)
                if (g == "hr" && b == "br")
                    a.replaceWith(r());
                else {
        ...
        function u(a, b) {
            ...
            return[{element: c, left: g, right: function(a, c) {
                        c.transform(a, b)
                    }}]
        }
        function o(a) {
        ...
        CKEDITOR.filter.prototype = {allow: function(b,
                    c, g) {
                if (this.disabled || this.customConfig && !g || !b)
                    return false;
                this._.cachedChecks = {};
                var d, e;
                if (typeof b == "string")
                        ...
                        a:{
                            ...
                            if (l)
                                for (n = 0; n < l.length; ++n)
                                    if ((o = g.match(l[n])) && o[0].length == g.length) {
                                        c = true;
                                        break a
                                    }
                ...
                d.length && (q = true);
                for (var n, o, a = [], c = ["p", "br", "div"][this.enterMode - 1]; n = d.pop(); )
                ...
                if (typeof a == "string") {
                    l = a + "<" + (b === false ? "0" : "1") +
                            (c ? "1" : "0") + ">";
                    if (l in this._.cachedChecks)
                        return this._.cachedChecks[l];
                    g = h(a).$1;
                    d = g.styles;
                    var n = g.classes;
                    g.name = g.elements;
            ...
            classes: "requiredClasses"}, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, n = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, w = CKEDITOR.filter.transformationsTools = {sizeToStyle: function(a) {
                ...
                if (typeof b == "string")
                    ...
                    for (e in d)
                        if (e == "class") {
                            c = a.classes.join("|");
                            for (p = d[e].split(/\s+/); h = p.pop(); )
                                c.indexOf(h) == -1 && a.classes.push(h)
                        } else
                            a.attributes[e] = d[e];
                    for (f in g)
                        a.styles[f] = g[f]
    ...
    CKEDITOR.resourceManager.prototype = {add: function(b, c) {
            ...
            for (var b = b.split(","), f = 0; f < b.length; f++)
                this.externals[b[f]] = {dir: c, file: a}
        }, load: function(b, c, a) {
            ...
            var e = {}, h = function(a) {
                b.call(this, a, function(a) {
                    ...
                    for (j in a) {
                        ...
                        if (!c[j]) {
                            if (q.icons)
                                for (var l = q.icons.split(","), g = l.length; g--; )
                                    CKEDITOR.skin.addIcon(l[g], q.path + "icons/" + (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") + l[g] + ".png");
                            c[j] = 1
                        }
                        if (r) {
                            r.split && (r = r.split(","));
    ...
    (function() {
        function b(b, e, f) {
            ...
            if (e !== void 0) {
                ...
                if (!(f == CKEDITOR.ELEMENT_MODE_INLINE ? e.is(CKEDITOR.dtd.$editable) || e.is("textarea") : f == CKEDITOR.ELEMENT_MODE_REPLACE ?
                        !e.is(CKEDITOR.dtd.$nonBodyContent) : 1))
                    throw Error('The specified element mode is not supported on element: "' + e.getName() + '".');
                this.element = e;
                this.elementMode = f;
        ...
        function m(a) {
            ...
            if (d)
                var f = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(f, ""), c = c + ("," + d);
            if (e)
                var h = RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?=,|$)", "g"), c = c.replace(h, "");
            ...
            CKEDITOR.plugins.load(c.split(","), function(c) {
                ...
                for (var l in c) {
                    ...
                    if (n && !a.lang[l]) {
                        n.split && (n = n.split(","));
                        if (CKEDITOR.tools.indexOf(n, a.langCode) >= 0)
                            o = a.langCode;
                        else {
                        ...
                        if (!q.langEntries ||
                                !q.langEntries[o])
                            f.push(CKEDITOR.getUrl(q.path + "lang/" + o + ".js"));
                        else {
                ...
                CKEDITOR.scriptLoader.load(f, function() {
                    ...
                    for (h = 0; h < a.config.blockedKeystrokes.length; h++)
                        a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[h]] =
                                1;
                    a.status = "loaded";
                    a.fireOnce("loaded");
                ...
                if (b(e))
                    ...
                    if (d == "br")
                        ...
                        for (; ; ) {
                            ...
                            if (!e.isUnknown && !u.isUnknown && !h[d])
                                if (u.isOptionalClose)
                                    l.onTagClose(g);
                                    ...
                                    u = g
                                } else if (d in CKEDITOR.dtd.$listItem && !r(d, g))
                                    l.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
                                else if (g in c && !r(d, g)) {
                                    !e.returnPoint &&
                                            (e.returnPoint = u);
                                    u = u.parent
                                } else {
    ...
    (function() {
        ...
        function d(a) {
            for (var b =
                ...
                if (b)
                    var d = a.type, f = a.name;
                var m = this[c].apply(window, arguments);
                if (m === false)
                    return m;
                if (b) {
                    if (m && (m.name != f || m.type != d))
                        return m
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({$: function(a) {
                ...
                a && this.addRules(a, 10)
                    ...
                    for (var b = [this._.elements["^"], this._.elements[a.name], this._.elements.$], c, d = 0; d < 3; d++)
                        if (c = b[d]) {
                            c = c.filter(a, this);
                            if (c === false)
                                return null;
    ...
    (function() {
        function b(b, c) {
                ...
                return function(d) {
                    if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        for (h =
                                0; h < l.length; h++)
                            i(l[h]);
                        if (l = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(d) !== false : c))
                            if (!q && CKEDITOR.env.ie && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                l = false;
                            else if (!q && CKEDITOR.env.ie && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem))
                                l = false;
                            else {
                                l = a(d);
            ...
            function p(a, b) {
                if ((!q || !CKEDITOR.env.ie) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                    return true;
                var c;
                if (a.type ==
                    ...
                    if (CKEDITOR.env.ie && q && (!b || a.parent.name in o))
                        return true;
                    if (!q)
                        if ((c = a.previous) && c.name == "br" || !c || e(c))
                            return true
                }
                return false
            }
            ...
            for (r in o)
                "#"in s[r] || delete o[r];
            for (r in o)
                n.elements[r] = l(q, b.config.fillEmptyBlocks !== false);
            n.root = l(q);
        ...
        var F = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", s = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, s.$blockLimit, s.$block), t = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, C = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus",
                    ""]], elements: {$: function(a) {
                    var b = a.attributes;
                    if (b) {
                        if (b["data-cke-temp"])
    ...
    (function() {
        ...
        CKEDITOR.inlineAll = function() {
            ...
            for (a in CKEDITOR.dtd.$editable)
                for (var f = CKEDITOR.document.getElementsByTag(a), d = 0, e = f.count(); d < e; d++) {
                    b = f.getItem(d);
                    if (b.getAttribute("contenteditable") == "true") {
                        c = {element: b, config: {}};
            ...
            for (var a = document.getElementsByTagName("textarea"), b = 0; b < a.length; b++) {
                ...
                if (f.name || f.id) {
                    if (typeof arguments[0] == "string") {
                        if (!RegExp("(?:^|\\s)" + arguments[0] + "(?:$|\\s)").test(f.className))
                            continue
                    } else if (typeof arguments[0] == "function") {
                        c = {};
                        if (arguments[0](f, c) === false)
                            continue
                    }
                    this.replace(f, c)
                }
            ...
            $: function(a, b) {
                ...
                this.setup()
                    ...
                    if (!b) {
                        var f = /\n{2}/g;
                        if (f.test(a))
                            var h = "<" + c + ">", i = "</" + c + ">", a = h + a.replace(f, function() {
                            return i + h
                        }) + i
                    }
                    a = a.replace(/\n/g, "<br>");
                    ...
                    for (var c = this.editor, d = c.config.enterMode,
                        ...
                        if (!o.checkReadOnly()) {
                            ...
                            var x, z;
                            if (j)
                                for (; (x = o.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[x.getName()]) && (!z || !z[i]); )
                                    if (x.getName()in CKEDITOR.dtd.span)
                                        o.splitElement(x);
                                        ...
                                        o.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                            o.insertNode(m);
                            k ||
                                    (k = m)
                        }
                    ...
                    if (k) {
                        ...
                        if (j)
                            if ((b = k.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))
                                b.getDtd()["#"] ? o.moveToElementEditStart(b) : o.moveToElementEditEnd(k);
                        ...
                        this.attachListener(a, "key", function(b) {
                            ...
                            if (c in{8: 1, 46: 1}) {
                                ...
                                if (e = d(e)) {
                                    ...
                                    if ((l = f.block) && b[c ? "checkStartOfBlock" : "checkEndOfBlock"]() && (j = l[c ? "getPrevious" : "getNext"](i)) && j.is("table")) {
                                        a.fire("saveSnapshot");
                                        ...
                                        a.fire("saveSnapshot");
                                        g = 1
                                    } else if ((h = f.contains(["td", "th", "caption"])) && b.checkBoundaryOfElement(h, c ? CKEDITOR.START : CKEDITOR.END))
                                        g = 1
                            }
                            return!g
                        });
        ...
        var m = function() {
            ...
            function c(a, d) {
                ...
                for (var l = i[l.getName()], o = 0, p = a.getChildren(), j = p.count(), m = -1, k = -1, v = 0, F = g.contains(i.$list); o < j; ++o) {
                    ...
                    if (b(g)) {
                        ...
                        n.push({isElement: 0, node: g, allowed: 1})
                }
                if (m > -1)
                    n[m].firstNotAllowed = 1;
                if (k > -1)
                    n[k].lastNotAllowed = 1;
                return n
            }
            function d(a, c) {
            ...
            return function(o, k, z) {
                ...
                if (!C.checkReadOnly()) {
                    ...
                    for (; (D = b(t.startContainer) && t.startContainer.getChild(t.startOffset - 1)) && b(D) && D.isBlockBoundary() && I.contains(D); )
                        t.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END);
                    ...
                    for (n = w.startNode; (n = n.getParent()) && g(n); )
                        y.push(n);
                    t.moveToBookmark(w);
                    if (w = z) {
                        w = k.range;
                        ...
                        if (/^\s+|\s+$/.test(z) && "span"in CKEDITOR.dtd[D])
                        ...
                        if ((L = w.startPath().block) && !(L.getChildCount() == 1 && L.getBogus()))
                            a:{
                                var E;
                    ...
                    for (P = J.createBookmark(); H = k.zombies.pop(); )
                        if (H.getParent()) {
                            N = J.clone();
    ...
    (function() {
        ...
        function j(a, b, c) {
            ...
            if (CKEDITOR.env.ie)
                var e = a.getDocument().on("selectionchange", function(a) {
                    a.cancel()
                }, null, null, -100);
            else {
        ...
        CKEDITOR.on("instanceCreated", function(a) {
            ...
            f.on("contentDom", function() {
                ...
                if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                    ...
                    g.attachListener(CKEDITOR.env.ie ? g : a.getDocumentElement(), "mouseup", c, f);
        ...
        CKEDITOR.dom.selection = function(a) {
            ...
            if (CKEDITOR.env.webkit)
                (b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, b);
            else if (CKEDITOR.env.gecko)
                b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && j(a, b, true);
                ...
                if (q)
                    b.type == "None" && (c && c.equals(this.document.getDocumentElement())) &&
                            j(a, null, true);
                else {
            ...
            if (c)
                if (c.getRangeAt)
                    e = (f = c.rangeCount && c.getRangeAt(0)) && new CKEDITOR.dom.node(f.commonAncestorContainer);
                else {
                    try {
                        f = c.createRange()
                    } catch (h) {
        ...
        CKEDITOR.dom.selection.prototype = {getNative: function() {
                ...
                if (!c || !c.rangeCount)
                    ...
                    if (d == c.endContainer &&
                            d.nodeType == 1 && c.endOffset - c.startOffset == 1 && r[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                        b = CKEDITOR.SELECTION_ELEMENT
                }
                return a.type = b
            }, getRanges: function() {
                var a = q ? function() {
                    ...
                    var b = function(b, c) {
                        ...
                        e = l.text.replace(/(\r\n|\r)/g, "\n").length;
                        if (!e)
                            return{container: d, offset: a(h) + (n > 0 ? 0 : 1)};
                        for (; e > 0; )
                            try {
                        ...
                        for (var d = c.ranges, e = 0; e < d.length; e++) {
                            ...
                            if (!f.collapsed) {
                                if (f.startContainer.isReadOnly())
                                    for (var b = f.startContainer, h; b; ) {
                                        if ((h = b.type == CKEDITOR.NODE_ELEMENT) && b.is("body") || !b.isReadOnly())
                                            break;
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function() {
                    return b.getNative().createRange().item(0)
                        ...
                        function() {
                            for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && r[c.getName()] && (d = c))); e--)
                ...
                if (a.length)
                    if (this.isLocked) {
                        ...
                        if (q) {
                            ...
                            if (m && m.type == CKEDITOR.NODE_ELEMENT && m.getName()in r && (!m.is("a") || !m.getText()))
                                try {
                            ...
                            for (d = 0; d < a.length; d++) {
                                ...
                                if (b.collapsed && CKEDITOR.env.webkit && f(b)) {
                                    ...
                                    if ((i = k.getNext()) && !k.getPrevious() && i.type == CKEDITOR.NODE_ELEMENT &&
                                        ...
                                        b.moveToPosition(k, CKEDITOR.POSITION_AFTER_END)
                                }
                                j.setStart(b.startContainer.$, b.startOffset);
                                try {
    ...
    (function() {
                ...
                for (m.getPosition(l) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m; ) {
                    ...
                    if (g && q && !q.collapsed) {
                        for (var g = p(this, c), o = g.hasAttributes(), u = q.getCommonAncestor(), s = {}, t = {}, v = {}, z = {}, y, A, F; g && u; ) {
                            if (u.getName() == d) {
                                for (y in e.attributes)
                                    if (!z[y] && (F = u.getAttribute(A)))
                                        g.getAttribute(y) == F ? t[y] = 1 : z[y] = 1;
                                for (A in e.styles)
                                    if (!v[A] && (F = u.getStyle(A)))
                                        g.getStyle(A) == F ? s[A] = 1 : v[A] = 1
                            }
                            u = u.getParent()
                        }
                        for (y in t)
        ...
        function j(a, b) {
            ...
            if (d && !e) {
                ...
                f ? b = m(c ? [a.getHtml()] : i(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, j;
        ...
        function q(a) {
            ...
            for (f in c)
                if (!((f == "class" || this._.definition.fullMatch) && a.getAttribute(f) != F(f, c[f]))) {
                    e = a.hasAttribute(f);
                    a.removeAttribute(f)
                }
            for (var h in b)
                if (!(this._.definition.fullMatch && a.getStyle(h) != F(h, b[h], true))) {
                    e = e || !!a.getStyle(h);
                    a.removeStyle(h)
                }
            l(a, d, s[a.getName()]);
        ...
        function r(a) {
            for (var b = o(this), c = a.getElementsByTag(this.element), d = c.count(); --d >= 0; )
        ...
        function u(a, b) {
            for (var c in a)
                a[c] = a[c].replace(t, function(a, c) {
                    return b[c]
                })
        }
        function o(a) {
                        ...
                        if (j && a.length > 1) {
                            if (!e)
                                for (var i = a.length - 1; i >= 0; i--)
                                    c.unshift(a[i].createBookmark(true));
                            if (h)
                                for (var k = 0; a[e + k + 1]; ) {
                                    for (var m = j.document, h = 0, i = m.getById(c[k].endNode), m = m.getById(c[k +
                                        ...
                                        if (m.equals(i))
                                            h = 1;
                                        else if (b(i) || i.type == CKEDITOR.NODE_ELEMENT && i.isBlockBoundary())
                                            continue;
                                        break
                                    }
                                    if (!h)
            ...
            function i(d, b) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    setTimeout(function() {
                        ...
                        j.remove();
                        var d;
                        if (CKEDITOR.env.webkit && (d = j.getFirst()) && d.is && d.hasClass("Apple-style-span"))
                            j = d;
    ...
    (function() {
        ...
        function q(e) {
            for (var e = e.getSelection().getRanges(!0), c = e.length - 1; 0 < c; c--)
                e[c].deleteContents();
            return e[0]
        }
                ...
                if (b = b || q(e)) {
                    ...
                    if (j && h) {
                        if (a && (a.is("li") ||
                            ...
                            if (d.is("li"))
                                if (i || m)
                                    a[i ? "insertBefore" : "insertAfter"](d);
                                else
                                    a.breakParent(d);
                            else {
                                if (e)
                                    if (d = f.createElement(c == CKEDITOR.ENTER_P ? "p" : "div"), l && d.setAttribute("dir", j), n && d.setAttribute("style", n), h && d.setAttribute("class",
                                            h), a.moveChildren(d), i || m)
                                        d[i ? "insertBefore" : "insertAfter"](b);
                                    else
                                        a.breakParent(b), d.insertAfter(b);
                                else if (a.appendBogus(), i || m)
                                    for (; f = a[i?"getFirst":"getLast"](); )
                                        f[i ? "insertBefore" : "insertAfter"](b);
                                else
                                    for (a.breakParent(b); f = a.getLast(); )
                                        f.insertAfter(b);
                                a.remove()
                            }
                            k.selectBookmarks(g);
                    ...
                    if (h = b.splitBlock(k)) {
                        ...
                        j = h.wasEndOfBlock;
                        if (a)
                            g = a.getParent(), g.is("li") && (a.breakParent(g), a.move(a.getNext(), 1));
                        else if (c && (g = c.getParent()) && g.is("li"))
                            c.breakParent(g), g = c.getNext(), b.moveToElementEditStart(g), c.move(c.getPrevious());
                        if (!e && !j)
                            a.is("li") && (d = b.clone(), d.selectNodeContents(a), d = new CKEDITOR.dom.walker(d), d.evaluator =
                                    function(a) {
                                        return!(u(a) || t(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName()in CKEDITOR.dtd.$inline && !(a.getName()in CKEDITOR.dtd.$empty))
                                    }, (g = d.next()) && (g.type == CKEDITOR.NODE_ELEMENT && g.is("ul", "ol")) && (CKEDITOR.env.ie ? f.createText(" ") : f.createElement("br")).insertBefore(g)), a && b.moveToElementEditStart(a);
                        else {
                            if (c) {
                                if (c.is("li") || !r.test(c.getName()) && !c.is("pre"))
                                    d = c.clone()
                            } else
                                a && (d = a.clone());
                            ...
                            if (CKEDITOR.env.ie && e && (!j || !c.getChildCount()))
                                b.moveToElementEditStart(j ? c : d), b.select();
            ...
            CKEDITOR.ui.listBlock = CKEDITOR.tools.createClass({base: CKEDITOR.ui.panel.block, $: function(a, b) {
                    ...
                    focus: function(a) {
                        ...
                        if (a)
                            ...
                            b = CKEDITOR.document.getWindow().getScrollPosition().y, this.element.focus(), CKEDITOR.env.webkit && (CKEDITOR.document[CKEDITOR.env.webkit ? "getBody" : "getDocumentElement"]().$.scrollTop = b);
    ...
    (function() {
        ...
        var j = CKEDITOR.tools.createClass({$: function(a) {
                ...
                this._.docTitle =
                    ...
                    var b = this.editor;
                    if (d)
                        this.setHtml(a), b.fire("dataReady");
                    else {
    ...
    (function() {
        function s(e) {
            function g(b) {
                for (var f = d.startContainer, a = d.endContainer; f && !f.getParent().equals(b); )
                    f = f.getParent();
                ...
                for (a = f.getCustomData("listarray_index") + 1; a < c.length && c[a].indent > g; a++)
                    c[a].indent += h;
                f = CKEDITOR.plugins.list.arrayToList(c, o, null, e.config.enterMode, b.getDirection());
                if (!n.isIndent) {
                    var i;
                    if ((i = b.getParent()) && i.is("li"))
                        for (var h = f.listNode.getChildren(), m = [], j, a = h.count() - 1; 0 <= a; a--)
                            (j = h.getItem(a)) && (j.is &&
                                    j.is("li")) && m.push(j)
                }
                ...
                if (m && m.length)
                    for (a = 0; a < m.length; a++) {
                        for (j = b = m[a]; (j = j.getNext()) && j.is && j.getName()in k; )
            ...
            for (var n = this, o = this.database, k = this.context, l = e.getSelection(), l = (l && l.getRanges(1)).createIterator(), d; d = l.getNextRange(); ) {
                for (var b = d.getCommonAncestor(); b && !(b.type == CKEDITOR.NODE_ELEMENT && k[b.getName()]); )
                    b = b.getParent();
                ...
                function g(e, g) {
                    ...
                    e.on("key", function(g) {
                        if ("wysiwyg" == e.mode && g.data.keyCode == this.indentKey) {
                            ...
                            if (d && (!this.isIndent || !p.call(this, e.elementPath(), d)))
                                e.execCommand(this.relatedGlobal), g.cancel()
                        }
                    }, this);
    ...
    CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function() {
            ...
            c && c.push(function(a, c) {
                if ("a" == c && (CKEDITOR.plugins.link.tryRestoreFakeAnchor(b,
                        a) || a.getAttribute("name") && (!a.getAttribute("href") || !a.getChildCount())))
                    return"anchor"
            })
        }});
    ...
    (function() {
        ...
        function da(a) {
            ...
            q(d, {attach: function() {
                    ...
                    for (var R in k)
                        k[R] = CKEDITOR.tools.cssLength(k[R]);
                    this.setStyles(k)
                }, look: function(a) {
                    if (this.oldLook != a) {
                        for (var b = this.lineChildren.length, d; b--; )
                            (d = this.lineChildren[b]).setAttribute("style", d.base + d.looks[0 | a / 2]);
                        this.oldLook = a
                    }
        ...
        function p(a) {
            ...
            var b;
            if (!(b = U(a)))
                m(a) ? (b = {left: 1, right: 1, center: 1}, b = !(!b[a.getComputedStyle("float")] && !b[a.getAttribute("align")])) : b = !1;
            return b
        }
        function U(a) {
        ...
        function X(a) {
            ...
            if (b.y > f.size.top - 1 && b.y < f.size.top + e)
                ...
                return null;
            if (p(f) || fa(a, f, j) || f.getParent().is(Y))
                return null;
            var g = r(a, f, !j);
            if (g) {
                if (g && g.type == CKEDITOR.NODE_TEXT)
                    return null;
                if (m(g)) {
                    if (p(g) || !F(a, g) || g.getParent().is(Y))
                        return null;
                    c = [g, f][j ? "reverse" : "concat"]().concat([M, G])
                }
            } else
                f.equals(a.editable[j ? "getLast" : "getFirst"](a.isRelevant)) ? (C(a), j && b.y > f.size.bottom - e && b.y < d.pane.height && f.size.bottom > d.pane.height - e && f.size.bottom <
        ...
        function N(a, b, d, e) {
            ...
            }(), c = b.getDocumentPosition(), h = {}, j = {}, g = {}, i = {}, l = t.length; l--; )
                h[t[l]] = parseInt(f("border-" +
        ...
        function o(a, b, d) {
            if (!m(b))
                return b.size = null;
            if (b.size) {
                if (b.size.ignoreScroll == d && b.size.date > new Date - Z)
                    return null
            } else
                b.size = {};
                        ...
                        if ("wysiwyg" == a.mode)
                            if (c.inInlineMode) {
                                ...
                                if (!(d > e.left - f.x && d < e.right - f.x) || !(b > e.top - f.y && b < e.bottom - f.y))
                                    clearTimeout(g), g = null, c.line.detach()
                            } else
                                clearTimeout(g), g = null, c.line.detach()
                            ...
                            b : e, "mousemove", function(b) {
                                ...
                                if (!("wysiwyg" != a.mode || a.readOnly || g)) {
                                    ...
                                    g = setTimeout(function() {
                                        ...
                                        g = c.trigger = null;
                                        H(c);
                                        if (j && !c.hiddenMode && a.focusManager.hasFocus && !c.line.mouseNear() && (c.element = $(c, !0)))
                                            (c.trigger = V(c) || X(c) || aa(c)) ? c.line.attach().place() : (c.trigger = null, c.line.detach()), j = !1
                                    }, 30)
                                }
        ...
        var $ = function() {
            ...
            function a(a) {
                ...
                if (!(a.mouse.y > f.size.top && a.mouse.y < c.size.bottom))
                    return null;
                for (var e = Number.MAX_VALUE, j, g, i, l; c && !c.equals(f) && (g = f.getNext(a.isRelevant)); )
                    j = Math.abs(ca(a, f, g) - a.mouse.y), j < e && (e = j, i = f, l = g), f = g, o(a, f);
                if (!i || !l || !(a.mouse.y > i.size.top && a.mouse.y < l.size.bottom))
                    return null;
                h.upper = i;
                h.lower = l;
                return h.set(M, ba)
    ...
    (function() {
        var h, i = {modes: {wysiwyg: 1, source: 1}, canUndo: !1, readOnly: 1, exec: function(a) {
                ...
                if (b.fullPage)
                    ...
                    d && (d.getAttribute("id") && (b += 'id="' + d.getAttribute("id") + '" '), d.getAttribute("class") && (b += 'class="home page page-id-54 page-template page-template-template-homepage-php body-class ' + d.getAttribute("class") + '" '));
                    g = a.config.docType + '<html dir="' + a.config.contentsLangDirection +
                            '"><head>' +
                            '<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>' +
                            '<meta name="viewport" content="width=device-width, initial-scale=1.0">' +
                            '<link rel="profile" href="http://gmpg.org/xfn/11" />' +
                            "<link rel='stylesheet' id='ct-shortcodes-css'  href='/css/blog/plugins/ct-shortcodes/shortcodes.css' type='text/css' media='all' />" +
                            ...
                            "<link rel='stylesheet' id='bootstrap-main-style-css'  href='/css/blog/themes/bootstrap.min.css' type='text/css' media='all' />" +
                            "<link rel='stylesheet' id='font-awesome-style-css'  href='/css/blog/themes/font-awesome.min.css' type='text/css' media='all' />" +
                            "<link rel='stylesheet' id='ct-superfish-jquery-css'  href='/css/blog/themes/superfish.css' type='text/css' media='all' />" +
                            "<link rel='stylesheet' id='ct-woocommerce-css'  href='/css/blog/themes/woocommerce.css' type='text/css' media='all' />" +
                            "<link rel='stylesheet' id='ct-style-css'  href='/css/blog/themes/wp-lynx/style.css' type='text/css' media='all' />" +
                            "<link rel='stylesheet' id='ct-rwd-style-css'  href='/css/blog/themes/rwd-styles.css' type='text/css' media='all' />" +
                            "<link rel='stylesheet' id='options-css-style-css'  href='/css/blog/themes/options.css' type='text/css' media='all' />" +
                            "<script type='text/javascript' src='/js/blog/jquery.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/jquery-migrate.min.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/jquery.ui.core.min.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/jquery.ui.widget.min.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/jquery.ui.accordion.min.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/jquery.ui.tabs.min.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/plugins/ct-shortcodes/ct-shortcodes-lib.js'></script>" +
                            "<script type='text/javascript' src='/js/blog/comment-reply.min.js'></script>" +
                            '<style type="text/css">.masonry-box {width: 32%; margin-right: 15px; margin-left: 0;}.category-blog > .masonry-box {}</style>' +
                            '<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Signika%20Negative:300,400,400italic,700,700italic" type="text/css" />' +
                            '<style type="text/css">h1,h2,h3,h4,h5,h6 { font-family: "Signika Negative", Arial, sans-serif}</style><!-- Fav and touch icons -->' +
                            '<link rel="shortcut icon" href="/img/blog/favicon.ico">' +
                            '<link rel="apple-touch-icon-precomposed" sizes="144x144" href="/img/blog/icons/apple-touch-icon-144-precomposed.png">' +
                            '<link rel="apple-touch-icon-precomposed" sizes="114x114" href="/img/blog/icons/apple-touch-icon-114-precomposed.png">' +
                            '<link rel="apple-touch-icon-precomposed" sizes="72x72" href="/img/blog/icons/apple-touch-icon-72-precomposed.png">' +
                            '<link rel="apple-touch-icon-precomposed" href="/img/blog/icons/apple-touch-icon-57-precomposed.png">' +
                            e + "<title>" + a.lang.preview.preview + "</title>" + CKEDITOR.tools.buildStyleHtml(a.config.contentsCss) + "</head>" + (b + ">") +
                            ...
                            '<div class = "col-lg-3">' +
                            '<div id = "logo">' +
                            '<h1><a href = "#"><img src = "/img/blog/logo.png" alt = "" /></a></h1>' +
                            '</div> <!--/logo -->' +
                            '</div><!--/logo-block -->' +
                            ...
                            '<div class = "col-lg-12">' +
                            '<div class="entry-welcome"><div class="row"><div class="col-lg-6"><h1 class="archive-title  title_left">'+$("#nom_artigo").val()+'</h1><ul class="breadcrumb-list clearfix"><li><a href="/">Principal</a>/</li><li><a href="#" title="Preview">Preview</a>/</li><li>'+$("#nom_artigo").val()+'</li></ul></div><div class="col-lg-6"><nav class="nav-single clearfix"><h3 class="assistive-text">Navegador de Artigos</h3><span class="nav-previous"><a href="#" rel="prev"><span class="fa fa-chevron-left" title="Anterior"></span></a></span><span class="nav-next"></span></nav><div class="clear"></div></div></div></div>            </div> <!--/col-lg-12 -->' +
                            '</div> <!--/row -->' +
                            '</div> <!--/container -->' +
                            '</header> <!--#header -->' +
                            '<!--START CONTENT -->' +
                            '<style>img.left{float:left;}img.right{float:right;}</style>' +
                            '<div id="content" class="theme-container single-post" role="main">' +
                            '<div class="container">' +
                            '<div class="row">' +
                            '<div id="primary" class="col-lg-8 ">' +
                            '<article id="post-11" class="post-11 post type-post status-publish format-aside hentry instock" itemscope itemtype="http://schema.org/Article">' +
                            '<div class="page-content clearfix">' +
                            '<section class="entry-meta rw-cat-block clearfix">' +
                            '<div class="left-aside" style="background-color: #1e73be">' +
                            '<span class="meta-views" title="Visualizações">' +
                            '<i class="fa fa-eye"></i>' +
                            '2        </span><!-- .meta-views -->' +
                            '<span class="meta-likes" title="Likes">' +
                            '<span class="post-like">' +
                            '<a href="#" data-post_id="166">' +
                            '<span  title="Eu curti esse artigo" class="qtip like fa fa-heart"></span>' +
                            '</a>' +
                            ...
                            '<a href="#respond" title="Comentários">0</a>' +
                            '</span>' +
                            '<span class="meta-single-date updated">36 minutos atrás</span>' +
                            '</div> <!-- /left-aside -->' +
                            '<div class="right-aside">' +
                            '<a href="#" title="Ver todas as postagens de Preview">Preview</a>' +
                            '</div> <!-- /right-aside -->' +
                            '</section> <!-- rw-cat-block -->   ' +
                            '<div style="display:none;">' +
                            '<h1 class="entry-title" itemprop="name">' +
                            'Teste do Flickr no Editor                                </h1>' +
                            '</div>' +
                            '<div itemprop="articleBody" class="entry-content">' +
                            a.getData() +
                            '</div><div class="share-single clearfix"><!-- AddThis Button BEGIN -->' +
                            ...
                            '<li><a href="#" rel="tag">Preview</a></li>' +
                            '</ul>' +
    ...
    '<div id="author-block" class="clearfix">'+
        '<div id="author-avatar">'+
            "<img alt='' src='http://1.gravatar.com/avatar/73f701bd6506d9a9b2b617d1c531a440?s=48&amp;d=http%3A%2F%2F1.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D48&amp;r=G' class='avatar avatar-48 photo' height='48' width='48' />"+
        '</div>'+
        '<!-- #author-avatar -->'+
        '<div id="author-description">'+
            '<span class="author-name" itemprop="author">'+
                '<span class="author vcard">'+
                    '<a class="url fn n" href="/autor/" title="Ver o perfil de Rodrigo Daniel" rel="author">Rodrigo Daniel</a>'+
                '</span>'+
            '</span>'+
            ...
            '</p><!-- .add-author-info -->'+
            "<p>Olá! Meu nome é Rodrigo Daniel e este é um Blog de Exemplo.</p>"+
            '<a class="author-site" href="http://www.rodrigodaniel.com.br/">Visite meu Site</a>'+
...
' </article>'+
                ...
                '<div id="secondary" class="sidebar col-lg-4 " role="complementary">'+
                         '<aside id="ct-related-thumbs-widget-2" class="widget ct-related-thumbs-widget clearfix">'+
    '<!-- START POPULAR POSTS WIDGET -->'+
    '<h3 class="widget-title">Artigos Relacionados</h3>'+
    '<ul class="related-thumbs-widget clearfix">'+
                    '<li>'+
                                    '<a href="/artigos/v/titulo/testes/code/1" title="">'+
                        '<img width="100%" src="/media/2014/01/0_64485000_1390378652_list.jpg" class="attachment-thumbnail wp-post-image" alt="Testes" title="Testes" />'+
                    '</a>'+
                                            '</li>'+
                    '<li>'+
                                    '<a href="/artigos/v/titulo/testando-123/code/2" title="">'+
                        '<img width="100%" src="/media/2014/01/0_45436600_1390381174_list.jpg" class="attachment-thumbnail wp-post-image" alt="Testando 123" title="Testando 123" />'+
                    '</a>'+
                                            '</li>'+
                    '<li>'+
                                    '<a href="/artigos/v/titulo/teste-de-imagens-grandes/code/3" title="">'+
                        '<img width="100%" src="http://farm6.static.flickr.com/5497/11214531246_514d558238_s.jpg" class="attachment-thumbnail wp-post-image" alt="Teste de Imagens Grandes" title="Teste de Imagens Grandes" />'+
                    '</a>'+
                                            '</li>'+
                    '<li>'+
                                    '<a href="/artigos/v/titulo/teste-de-pattern/code/4" title="">'+
                        '<img width="100%" src="/media/2014/01/0_71764600_1390382041_list.jpg" class="attachment-thumbnail wp-post-image" alt="Teste de Pattern" title="Teste de Pattern" />'+
                    '</a>'+
                                            '</li>'+
            '</ul>'+
    '<!-- END RELATED THUMBS WIDGET -->'+
'</aside>                             <!-- START CATEGORIES WIDGET -->'+
' <aside id="ct_categories_widget-2" class="widget ct-categories-widget clearfix">'+
       ' <h3 class="widget-title">Categorias</h3>'+
        '<div class="row">'+
            '<div class="col-lg-6">'+
                '<ul class="left-col">'+
                                            '<li>'+
                            '<a href="/artigos/categoria/t/android/code/6" title="">Android</a>'+
                        '</li>'+
                                            '<li>'+
                            '<a href="/artigos/categoria/t/games/code/1" title="Categoria relacionada ao conte&uacute;do dos jogos para todos os tipos de plataforma.'+
'">Games</a>'+
                        '</li>'+
                                            '<li>'+
                            '<a href="/artigos/categoria/t/programaasapo/code/4" title="">Programação</a>'+
                        '</li>'+
                                            '<li>'+
                            '<a href="/artigos/categoria/t/teste/code/2" title="">Teste</a>'+
                        '</li>'+
                                    '</ul><!-- left-col -->'+
            '</div><!-- col-lg-6 -->'+
            '<div class="col-lg-6">'+
                '<ul class="right-col">'+
                                            '<li>'+
                            '<a href="/artigos/categoria/t/apple/code/5" title="">Apple</a>'+
                        '</li>'+
                                           '<li>'+
                            '<a href="/artigos/categoria/t/outro/code/3" title="">Outro</a>'+
                        '</li>'+
                                            '<li>'+
                            '<a href="/artigos/categoria/t/sacries/code/7" title="">Séries</a>'+
                        '</li>'+
                                    '</ul><!-- right-col -->'+
            '</div><!-- col-lg-6 -->'+
        '</div><!-- row -->'+
    ...
    '</div><!-- /col-lg-4 -->'
        ...
        '</div><!-- /row -->'+
    '</div> <!-- /#content -->'+
     '<footer id = "footer" role = "contentinfo"><div class = "container clearfix"><div class = "row"></div></div></footer>'+
    ...
    (function() {
        ...
        CKEDITOR.plugins.scayt = {engineLoaded: !1, instances: {}, controlInfo: {}, setControlInfo: function(a, c) {
                a && (a.name && "object" !=
                        typeof this.controlInfo[a.name]) && (this.controlInfo[a.name] = {});
                for (var b in c)
                ...
                if (a && a.name && this.controlInfo[a.name])
                ...
                b[3] = "1";
                for (var d = 0; 4 > d; d++)
                    c[d] = "undefined" != typeof window.scayt &&
        ...
        var d = CKEDITOR.plugins.scayt, s = function(a, c, b, d, e, k, g) {
            ...
            a.addMenuItem(d, {label: b, command: d, group: k, order: g})
                ...
                if (d.isScaytReady(a)) {
                    ...
                    !a.config.scayt_autoStartup && 0 <= d.engineLoaded &&
    ...
    (function() {
        ...
        f.prototype = {equalsContent: function(a) {
                ...
                if (c || a) {
                    ...
                    for (var d = 0; d < c.length; d++) {
                        var b = c[d], e = a[d];
                        if (b.startOffset != e.startOffset || b.endOffset != e.endOffset || !CKEDITOR.tools.arrayCompare(b.start, e.start) || !CKEDITOR.tools.arrayCompare(b.end, e.end))
                            return!1
                    }
                }
                return!0
        ...
        g.prototype = {type: function(a, c) {
                ...
                if (this.currentImage)
                    if (c.equalsContent(this.currentImage)) {
                        if (a || c.equalsSelection(this.currentImage))
                            return!1
                    } else
