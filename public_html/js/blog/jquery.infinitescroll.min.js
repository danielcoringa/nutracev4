(function(o, i, k) {
    ...
    i.infinitescroll.prototype = {_binding: function g(F) {
            ...
            G.loading.msg = G.loading.msg || i('<div id="infscr-loading"><img alt="Carregando..." src="' + G.loading.img + '" /><div>' + G.loading.msgText + "</div></div>");
            ...
            switch (K) {
                ...
                case"html":
                    ...
                    i.ajax({url: D, dataType: G.dataType, complete: function H(L, M) {
                ...
                case"json":
                    E._debug("Using " + (K.toUpperCase()) + " via $.ajax() method");
                    i.ajax({dataType: "json", type: "GET", url: D, success: function(N, O, M) {
    ...
    var x = i.event, s;
    x.special.smartscroll = {setup: function() {
