var App = function() {
    ...
    var g = function() {
        ...
        $(".color-picker").colorpicker().on("changeColor", function(t) {
            ...
            e.attr("style","background-color:"+ t.color.toHex());
        })
    }, M = function() {
        $.fn.raty.defaults.path = "/img/admin/jquery-raty/", $("#score-demo").raty({score: 3}), $("#number-demo").raty({number: 10}), $("#readOnly-demo").raty({readOnly: !0, score: 2}), $("#halfShow-true-demo").raty({score: 3.26}), $("#starHalf-demo").raty({path: "/img/admin/jquery-raty/", half: !0, starOff: "cookie-off.png", starOn: "cookie-on.png", starHalf: "cookie-half.png"}), $("#star-off-and-star-on-demo").raty({path: "/img/admin/jquery-raty/", starOff: "off.png", starOn: "on.png"}), $("#cancel-off-and-cancel-on-demo").raty({path: "/img/admin/jquery-raty/", cancel: !0, cancelOff: "cancel-custom-off.png", cancelOn: "cancel-custom-on.png", starOn: "star-on.png", starOff: "star-off.png"}), $("#size-demo").raty({path: "/img/admin/jquery-raty/", cancel: !0, cancelOff: "cancel-off-big.png", cancelOn: "cancel-on-big.png", half: !0, size: 24, starHalf: "star-half-big.png", starOff: "star-off-big.png", starOn: "star-on-big.png"}), $("#target-div-demo").raty({cancel: !0, target: "#target-div-hint"})
    }, Q = function() {
        ...
        $("#datatable1").dataTable({sPaginationType: "bs_full"}),
                $("#datatable2").dataTable({sPaginationType: "bs_full", sDom: "<'row'<'dataTables_header clearfix'<'col-md-4'l><'col-md-8'Tf>r>>t<'row'<'dataTables_footer clearfix'<'col-md-6'i><'col-md-6'p>>>", oTableTools: {aButtons: ["copy", "print", "csv", "xls", "pdf"], sSwfPath: "js/datatables/extras/TableTools/media/swf/copy_csv_xls_pdf.swf"}}), $(".datatable").each(function() {
        ...
        $("#e1").select2(), $("#e2").select2(), $("#e3").select2({placeholder: "Selecione uma Opção", allowClear: !0}), $("#e4").select2({placeholder: "Selecione uma Opção"}), $("#e5").select2({placeholder: "Select 2 characters", minimumInputLength: 2}), $("#e6").select2({placeholder: "Select a maximum of 3 states", maximumSelectionSize: 3}), $("#e7").select2({placeholder: "Search for a movie", minimumInputLength: 1, ajax: {url: "http://api.rottentomatoes.com/api/public/v1.0/movies.json", dataType: "jsonp", data: function(e) {
        ...
        e(), $(".ckeditor").wysiwyg({fileUploadError: t}), CKEDITOR.disableAutoInline = !0
    }, V = function() {
        try {
        ...
        var e = function(e) {
            $("#skin-switcher").attr("href", "/css/admin/themes/" + e + ".css"), $.cookie("skin_color", e)
        };
        ...
        $.cookie("gritter_show") || ($.cookie("gritter_show", 1), setTimeout(function() {
            var e = $.gritter.add({title: "Welcome to Cloud Admin!", text: "Cloud is a feature-rich Responsive Admin Dashboard Template with a wide array of plugins!", image: "/img/admin/gritter/cloud.png", sticky: !0, time: "", class_name: "my-sticky-class"});
            setTimeout(function() {
                $.gritter.remove(e, {fade: !0, speed: "slow"})
            }, 12e3)
        }, 2e3), setTimeout(function() {
            var e = $.gritter.add({title: "Customize Cloud Admin!", text: "Cloud Admin is easily customizable, lightweight and has a great User Experience.", image: "/img/admin/gritter/settings.png", sticky: !0, time: "", class_name: "my-sticky-class"});
            setTimeout(function() {
                $.gritter.remove(e, {fade: !0, speed: "slow"})
            }, 13e3)
        }, 8e3), setTimeout(function() {
            $.extend($.gritter.options, {position: "top-left"});
            var e = $.gritter.add({position: "top-left", title: "Buy Cloud Admin!", text: "Purchase Cloud Admin theme and get access to future updates at no extra cost. Buy now!", image: "/img/admin/gritter/buy.png", sticky: !0, time: "", class_name: "my-sticky-class"});
    ...
    return{init: function() {
            ...
            lastBlockedUI = e, jQuery(e).block({message: '<img src="/img/admin/loaders/12.gif" align="absmiddle">', css: {border: "none", padding: "2px", backgroundColor: "none"}, overlayCSS: {backgroundColor: "#000", opacity: .05, cursor: "wait"}})
