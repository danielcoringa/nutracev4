...
class Google_OAuth2 extends Google_Auth {
  ...
  public function authenticate($service, $code = null) {
    ...
    if ($code) {
      ...
      $request = Coringa_Google_Client::$io->makeRequest(new Google_HttpRequest(self::OAUTH2_TOKEN_URI, 'POST', array(), array(
          'code' => $code,
  ...
  private function refreshTokenRequest($params) {
    ...
    $request = Coringa_Google_Client::$io->makeRequest($http);
  ...
  public function revokeToken($token = null) {
    ...
    $response = Coringa_Google_Client::$io->makeRequest($request);
  ...
  private function getFederatedSignOnCerts() {
    ...
    $request = Coringa_Google_Client::$io->makeRequest(new Google_HttpRequest(
